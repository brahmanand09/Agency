...
// loginApp.post('/merchant', authenticate, async (req, res) => {
//     // Implement logic for saving merchant details to MongoDB
// });

// loginApp.get('/merchant', authenticate, async (req, res) => {
//     // Implement logic for fetching merchant details from MongoDB
// });

// loginApp.get('/search', authenticate, async (req, res) => {
//     // Implement logic for searching users in MongoDB
// });
